...
% بسته تنظیم اندازه و چینش عنوان شکل و جدول
\usepackage{caption}
...
% فونت انگلیسی حدود دو واحد کوچک‌تر از فارسی (Scale فارسی ۱٫۲ است)
\setlatintextfont[Path={./font/}, BoldFont={LiberationSerif-Bold.ttf}, BoldItalicFont={LiberationSerif-BoldItalic.ttf}, ItalicFont={LiberationSerif-Italic.ttf},Scale=0.95]{LiberationSerif-Regular.ttf}
...
% قواعد نگارشی قالب دانشکده (یادداشت برای نویسنده؛ در PDF چاپ نمی‌شود):
% - پانوشت فقط در اولین رخداد؛ شماره‌گذاری پانوشت در هر صفحه از یک
% - معادل فارسی واژه‌های تخصصی + اختصار در پرانتز در اولین رخداد
% - نیم‌فاصله در کلمات چندبخشی؛ علائم نگارشی چسبیده به کلمهٔ قبل
% - جمله با واژهٔ انگلیسی یا شمارهٔ مرجع شروع نشود
% - عنوان بخش‌ها بدون دونقطهٔ پایانی؛ حداکثر عمق شماره ۴ رقم
% - سبک مراجع IEEE؛ تناظر یک‌به‌یک متن و فهرست منابع

% دستوری برای تغییر نام کلمه «کتاب‌نامه» به «منابع علمی» (قالب دانشکده)
\renewcommand{\bibname}{منابع علمی}
\providecommand{\refname}{منابع علمی}
\renewcommand{\refname}{منابع علمی}
% دستوری برای تعریف واژه‌نامه انگلیسی به فارسی
\newcommand\persiangloss[2]{#1\dotfill\lr{#2}\\}
% دستوری برای تعریف واژه‌نامه فارسی به انگلیسی 
\newcommand\englishgloss[2]{#2\dotfill\lr{#1}\\}
% تعریف دستور جدید «\پ» برای خلاصه‌نویسی جهت نوشتن عبارت «رساله»
\newcommand{\پ}{رساله }

%\newcommand\BackSlash{\char`\\}

%%%%%%%%%%%%%%%%%%%%%%%%%%
% شماره‌گذاری راست‌به‌چپ بخش‌ها: ۱-۲-۳
\SepMark{-}
...
% نام فهرست‌ها و منابع بعد از زی‌پرشین تثبیت می‌شوند
\AtBeginDocument{%
	\renewcommand{\bibname}{منابع علمی}%
...
% شماره‌گذاری شکل/جدول/رابطه به صورت فصل-شماره
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% سربرگ صفحات: در هر صفحه فقط یک عنوان تا هم‌پوشانی نباشد
\pagestyle{fancy}
\fancyhead{}
\makeatletter
\fancyhead[C]{%
	...
	\else
		\parbox[t]{\textwidth}{\centering
			\ifdefined\@runningtitle\@runningtitle\else\@title\fi
		}%
	\fi
}
...
% شماره‌گذاری زیربخش‌ها حداکثر تا ۴ رقم (قالب دانشکده)
